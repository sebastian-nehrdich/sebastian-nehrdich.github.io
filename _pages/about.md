...
- May 18, 2026: I presented "Dharmamitra in 2026: Current Capabilities and Future Developments" and led a hands-on workshop "Accelerated Sanskrit Textual Scholarship in the Age of Agentic AI" at the Institute for Indology and Tibetology, Ludwig-Maximilians-Universität München. [More information here](https://www.kw.lmu.de/indotib/de/aktuelles/veranstaltungsuebersicht/veranstaltung/vortragsreihe-und-kolloquium-faebb01f.html).
- May 16, 2026: I led the workshop "Artificial Intelligence in Buddhist Studies" in Leipzig, focused on the use of AI in Buddhist Studies with particular emphasis on the Dharmamitra research tool.
- May 4, 2026: I gave the talk "Access as Nonviolence: Designing DH Platforms That Reduce Inequality" as part of the Ahiṃsā Lecture Series at the Asia-Africa Institute, University of Hamburg, in the joint Hamburg–Kyoto blended-learning partnership on nonviolence in global perspective.
- Mar 28-29, 2026: I participated in the international workshop "OCR and Beyond" at the Center for Integrated Japanese Studies (CIJS), Tohoku University, focused on philology and digital archives in the age of AI.
- Mar 20, 2026: I gave the talk "Dharmamitra: A Platform to Support Research across Language Boundaries on Buddhist Textual Material" at the Faculty of Arts and Philosophy, Ghent University, as part of the Gandhāra Corpora Lecture Series.
- Mar 17, 2026: I gave a guest lecture "DharmaNexus as a Multilingual Graph of Buddhist Intertextuality: Design Choices, Research Uses, and Future Applications" at the Ghent Centre for Buddhist Studies, on the invitation of Charles DiSimone, as part of the Gandhāra Corpora Lecture Series. [More information here](https://www.cbs.ugent.be/uncategorized/guest-lecture-dharmanexus-as-a-multilingual-graph-of-buddhist-intertextuality-design-choices-research-uses-and-future-applications-by-sebastian-nehrdich-march-17-2026).
- Mar 13, 2026: I delivered a hybrid lecture "Is This the End of (Buddhist) Philology as We Know It? If So, What's Next?" at the International Institute for Asian Studies, Leiden University.
- Mar 9-11, 2026: New paper at the 8th International Sanskrit Computational Linguistics Symposium (ISCLS 2026) at IIT Roorkee: Hellwig, O., Sellmer, S., Nehrdich, S., Widmer, P., & Sennrich, R. "Sanskrit Word Sense Disambiguation Based on Lexicographic Definitions." [PDF here](/files/sanskrit-wsd-iscls2026.pdf).
- Jan 31, 2026: I presented "Dharmamitra: A Data-Driven Platform for the Research of Buddhist Texts in Multiple Languages Using Advanced NLP Methods" at the 30th Information and Knowledge Science Forum, Doshisha University Osaka Satellite Campus.
- Jan 10, 2026: I co-presented "AI and Indological/Buddhological Researches: Dharmamitra/DharmaNexus and Its Application" with Kengo Harimoto (University of Naples "L'Orientale") at the 32nd Annual Conference of the Association for the Study of the History of Indian Thought, Kyoto University.
...
- Nov 12, 2025: I gave a talk for the Goodman Lecture Series No. 32 at the Khyentse Foundation on machine learning and Large Language Models in Buddhist Studies, with a focus on the tools that the Dharmamitra project offers the Buddhist Studies community. [More information here](https://khyentsefoundation.org/story/professor-sebastian-nehrdich/).
...
- Sep 12, 2025: I presented Dharmamitra and DharmaNexus at Academia Sinica in Taiwan with a focus on translation, search, and multilingular intertextuality analysis. [Here is the link to the workshop](https://www.litphil.sinica.edu.tw/main/posts/3041).
...
- Mar 14, 2025: Together with Xiang Wei and Marcus Bingenheimer, I will be conducting the workshop "Machine Translation for Asian Studies" at the AAS 2025 in Columbus, Ohio: [click here](https://asianstudies.confex.com/asianstudies/2025/meetingapp.cgi/Session/8470)
